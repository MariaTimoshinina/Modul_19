...
####
Создан новый проект. 
Структура проекта: создана папка tests, в ней создан файл test_pet_friends.py. 
В корневом каталоге создан файл api.py — это интерфейс взаимодействия с приложением. 
Там же создан Python файл settings.py, в нем записан email и пароль, с которыми мы зарегистрированы на сайте https://petfriends1.herokuapp.com/.
